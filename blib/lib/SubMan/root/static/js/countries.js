...
function print_country(country_id, selected, state_selected){
  ...
  var x, i = 3;
  option_str.options[0] = new Option('any', 'any');
  option_str.options[1] = new Option(country_arr[238], country_arr[238]);
  option_str.options[2] = new Option(country_arr[236], country_arr[236]);
  ...
  if (selected) {
    option_str.selectedIndex = selected;
    print_state('state', selected, state_selected);
  }
}
