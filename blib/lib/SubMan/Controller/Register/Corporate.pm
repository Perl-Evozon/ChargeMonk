package SubMan::Controller::Register::Corporate;
...
SubMan::Controller::Register::Corporate - Catalyst Controller
...
sub step_2_confirmation : Path('/register/corporate/step-2-confirmation') : Args(2) {
    ...
    my $link_subscription = $c->model('SubMan::LinkUserSubscription')->create(
        {   user_id            => $user_rs->id,
