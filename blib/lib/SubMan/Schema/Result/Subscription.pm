package SubMan::Schema::Result::Subscription;
...
__PACKAGE__->has_many(
    ...
    "SubMan::Schema::Result::LinkSubscriptionFeature",
...
__PACKAGE__->has_many(
    "period_users",
    "SubMan::Schema::Result::PeriodUser",
    { "foreign.subscription_id" => "self.id" },
    { cascade_copy              => 0, cascade_delete => 0 },
);
...
__PACKAGE__->has_many(
    ...
    "SubMan::Schema::Result::SubscriptionDowngradeTo",
...
__PACKAGE__->belongs_to(
    "subscription_group",
    "SubMan::Schema::Result::SubscriptionGroup",
...
__PACKAGE__->has_many(
    ...
    "SubMan::Schema::Result::SubscriptionUpgradeTo",
