...
SubMan::Common::Logger - Logger Tool for SubMan

=head1 DESCRIPTION

Initializes Log4perl and dispatches log messages for SubMan.
...
BEGIN {
    my $log_conf_file = "$FindBin::Bin/../conf/log4perl.conf";
...
our $logger = SubMan::Common::Logger->new();
...
Constructor for Subman::Common::Logger
