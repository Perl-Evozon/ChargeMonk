package SubMan::ValidationRule::Subscription::DiscountCodeNotUsed;
...
SubMan::ValidationRule::DiscountCode - Validates discount codes
...
sub validate_scalar {
    ...
    my $code = $self->{c}->model('SubMan::Code')->search( { 'code' =>  $value } )->first();
