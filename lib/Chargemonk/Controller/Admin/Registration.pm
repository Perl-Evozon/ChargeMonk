package Chargemonk::Controller::Admin::Registration;
...
Chargemonk::Controller::Admin::Registration - Catalyst Controller
...
sub registration : Path : Args(0) {
    ...
    my $registration = $c->model('Chargemonk::Registration')->find( {id => 1} );
    ...
    try {
        $c->model('Chargemonk::Registration')->update_or_create(
            {   id              => 1,
