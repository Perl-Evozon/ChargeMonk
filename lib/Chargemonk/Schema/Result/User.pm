package Chargemonk::Schema::Result::User;
...
__PACKAGE__->has_many(
    "link_user_subscription", "Chargemonk::Schema::Result::LinkUserSubscription",
    {"foreign.user_id" => "self.id"}, {cascade_copy => 0, cascade_delete => 0},
);

__PACKAGE__->has_many(
    "campaigns", "Chargemonk::Schema::Result::Campaign",
    {"foreign.user_id" => "self.id"}, {cascade_copy => 0, cascade_delete => 0},
);

__PACKAGE__->might_have(
    "user_psw_set_token", "Chargemonk::Schema::Result::UserPswSetToken",
    {"foreign.uid" => "self.id"}, {cascade_copy => 0, cascade_delete => 0},
);

__PACKAGE__->might_have(
    "user_registration_token", "Chargemonk::Schema::Result::UserRegistrationToken",
    {"foreign.user_id" => "self.id"}, {cascade_copy => 0, cascade_delete => 0},
);

__PACKAGE__->might_have(
    "discount_codes", "Chargemonk::Schema::Result::Code",
    {"foreign.user_id" => "self.id"}, {cascade_copy => 0, cascade_delete => 0},
);
